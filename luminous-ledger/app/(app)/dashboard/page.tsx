...
export default function DashboardPage() {
  ...
  // Aggregate daily spending for chart
  ...
  const weeklySpending = weeklyData.reduce((sum, d) => sum + d.amount, 0)
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-display-sm font-bold text-on-surface">
                ${Math.round(weeklySpending).toLocaleString()}
              </p>
            </div>
            <span className="flex items-center gap-1.5 rounded-full bg-success/12 text-success px-3 py-1 text-label-sm font-semibold">
              <TrendingUp size={12} />
              Current period
            </span>
          </div>
