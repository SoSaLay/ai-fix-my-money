...
const PERPLEXITY_COMPUTER_PROMPT = `You have access to my local filesystem. Your job is to gather my current financial data and write it directly to a file inside the AI Fix My Money project — do NOT return JSON in this chat.

TASK:
1. Find the AI Fix My Money project folder on this machine (it was downloaded from GitHub — search for a folder named "ai-fix-my-money" containing a "data" subfolder).
    ...
    <div className="flex flex-col gap-5 max-w-lg w-full">
      ...
      <div className="rounded-xl px-4 py-3 flex items-start gap-3" style={{ backgroundColor: 'rgba(76,73,201,0.08)' }}>
        ...
        <div className="min-w-0">
          ...
          <p className="text-label-sm font-mono" style={{ color: '#4c49c9' }}>ai-fix-my-money/data/financial-data.json</p>
        </div>
      </div>
