    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            { term: '1. Pay off high-interest debt', text: 'Money you owe at a high rate — a credit card at 24% is the usual example. Clear it before you invest anything: wiping out a 24% balance is a guaranteed 24% saved, and no investment promises that.' },
            { term: '2. Three to six months of savings', text: 'Cash you can reach quickly, enough to cover three to six months of your own costs. Build it next, so a lost job or a large bill is paid out of savings rather than out of new debt.' },
            { term: '3. Employer 401(k) match', text: 'A retirement account through your job, where your employer adds their own money on top of whatever you put in. Contribute at least enough to collect the full match — anything short of it is pay you never take home.' },
            { term: '4. Roth IRA', text: 'A retirement account you open yourself, with no employer involved: taxed on the way in, and not on the way out. Fund it next, so decades of growth come out untaxed.' },
            { term: '5. Rest of the 401(k)', text: 'Contributions past the match, which go in before tax. Keep contributing here to lower what you are taxed on this year and let the rest grow untaxed until you withdraw it.' },
            { term: '6. HSA (Health Savings Account)', text: 'A medical savings account, open to you only if you have a high-deductible health plan. Use it if you qualify — money goes in, grows, and comes out untaxed for medical bills, which no other account does.' },
            { term: '7. Taxable brokerage', text: 'An ordinary investment account, with no contribution limit and no lock-up. This is where the rest goes once the steps above are handled, and where you pay tax on your gains and dividends.' },
          ],
        },
      ],
      images: [
