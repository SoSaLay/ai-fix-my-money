...
export interface QuizQuestion {
   ...
   */
  imageSrc?: string
  /** The question asks for a number, so a calculator is offered beside it. */
  calculator?: boolean
...
export interface ActionStep {
   ...
   */
  label?: string
  /** What to have to hand before opening the tool. Short — a line each. */
  need: string[]
  /** What to do once in the tool. Three steps at most, a line each. */
  steps: string[]
  /** An optional extra shown under the steps. One or two short sentences. */
  bonus?: string
}
...
const ACCOUNTS: Track = {
  ...
  lessons: [
    ...
    },
    {
      ...
      sections: [
        ...
        {
          body: '“I just want to put money aside.”',
          gridTable: {
            columns: ['Asset account', 'What it is'],
            rows: [
        ...
        {
          body: '“I want my savings to grow. Pay me to save.”',
          gridTable: {
            columns: ['Asset account', 'What it is'],
            rows: [
        ...
        {
          body: '“I want money for when I stop working.”',
          gridTable: {
            columns: ['Asset account', 'What it is'],
            rows: [
        ...
        {
          body: '“I want money set aside for medical bills, tax-free.”',
          gridTable: {
            columns: ['Asset account', 'What it is'],
            rows: [
        ...
        {
          body: '“I use my credit card for everything.”',
          divider: true,
          gridTable: {
        ...
        {
          body: '“I don’t have all the money now. I’ll pay a little interest and pay it off monthly.”',
          gridTable: {
            columns: ['Liability account', 'What it is'],
            rows: [
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            { term: 'Credit utilization', text: 'What you owe divided by your limit. Keep it at 30% or lower.' },
      ...
      images: [
        {
          src: '/learning/accounts-utilization.svg',
          ...
          caption: 'The same $1,500 is 30% on one card and 75% on another. Utilization is the ratio, never the amount.',
        },
      ],
      questions: [
        {
  ...
  action: {
    ...
    need: [
      'Your phone, with your banking, card and payment apps',
      'Every account you have: bank, cards, loans, retirement',
    ],
    steps: [
      'Add each account and choose its type.',
      'Check your net worth at the bottom.',
    ],
  },
  finalQuiz: [
    {
    ...
    },
    {
      ...
      answer: 1,
      why: 'Payment history is the largest factor, and paying the statement balance in full is also what stops interest being charged at all. Closing the card shortens your history and raises utilization, a new application adds a hard inquiry, and checking your own score changes nothing.',
    },
    {
      id: 'acc-f1',
    ...
    {
      id: 'acc-f3',
      question: 'You owe $1,800 across cards with a combined limit of $6,000. What is your overall utilization?',
      options: ['18%', '30%', '33%', '60%'],
      answer: 1,
      calculator: true,
      why: '1,800 ÷ 6,000 = 0.30. Utilization is always the balance divided by the limit.',
    },
    {
      id: 'acc-f4',
...
const SPENDING: Track = {
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Like phone and utilities, subscriptions are a fixed cost — people just do not think of them that way. Most of us now pay for a handful of apps and tools.',
          bullets: [
      ...
      images: [
        {
          ...
          alt: 'Five horizontal bars for variable categories — groceries $412, eating out $326, transportation $187, shopping $146 and fun $93 — totalling $1,164.',
  ...
  action: {
    title: 'Record your month',
    need: [
      'Your banking app or last month’s statement',
      'Your subscriptions',
    ],
    steps: [
      'Add your monthly income.',
      'Add fixed or variable spending.',
      'Set a monthly spending limit.',
    ],
    bonus: 'Open your financial apps and go through your latest statements to spot costs that repeat. Don’t forget yearly charges — ones you pay once for the whole year. Divide them by 12 and add them here.',
  },
  finalQuiz: [],
}
...
const SAVINGS: Track = {
      ...
      sections: [
        {
          ...
          bullets: [
            { term: 'Savings account', text: '“I just want to put money aside.”' },
            { term: 'High-yield savings account', text: '“Pay me a better rate to keep it there.”' },
            { term: 'Money market account', text: '“Pay me more, and I can keep a bigger balance in it.”' },
            { term: 'CD (certificate of deposit)', text: '“Lock it away for a set term and pay me more.”' },
          ],
        },
        {
          heading: 'New here:',
          bullets: [
            { term: 'Money market fund', text: 'Not a bank account but an investment you hold at a brokerage. Often pays more, and is not FDIC insured.' },
  ...
  action: {
    ...
    need: [
      'Your monthly bills, from the last track',
      'One thing you want to save for',
    ],
    steps: [
      'Create a savings goal with a target.',
      'Set an emergency fund of three to six months of bills.',
      'Choose how much you save each month.',
    ],
  },
  finalQuiz: [],
}
...
const INVESTING: Track = {
  ...
  lessons: [
      ...
      sections: [
        {
          ...
          gridTable: {
            columns: ['Type', 'You would buy this if…', 'Risk'],
            risk: [1, 1, 1, 2, 2],
            rows: [
              [
                'ETFs',
                '“I want a slice of hundreds of companies instead of picking one.” Trades any time the market is open.',
                'Falls when the market falls, but no single company can sink you.',
              ],
              [
                'Mutual funds',
                '“Same basket, and I don’t need to trade during the day.” Priced once, after the market closes.',
                'Same as an ETF — it depends what is inside. Some charge higher fees.',
              ],
              [
                'Bonds & bond funds',
                '“I’ll lend my money out and collect interest.”',
                'Steadier than stocks, and still able to lose value.',
              ],
              [
                'REITs',
                '“I want income from property without buying a building.”',
                'Falls when property values, rents, or interest rates move against you.',
              ],
              [
                'Real estate',
                '“I want to own the building and collect the rent.”',
                'Tied up for months, in one property, usually with a mortgage against it.',
              ],
            ],
          },
        },
        {
          ...
          gridTable: {
            ...
            rows: [
              [
                'Individual stocks',
                '“I believe in this one company.”',
                'One company decides your result, and it can fall and not come back.',
              ],
              [
                'Crypto',
                '“I want digital currency, and I can stomach a big swing for a shot at a big gain.”',
                'Prices can fall far and fast, with no earnings underneath.',
              ],
            ],
          },
        },
        {
          ...
          gridTable: {
            ...
            rows: [
              [
                'Options',
                '“I’m betting on where a price lands by a certain date.”',
                'Worth nothing if you are wrong, and some trades lose more than you put in.',
              ],
              [
                'Futures',
                '“Same bet, with borrowed money behind it.”',
                'Leverage multiplies losses, past what you invested.',
              ],
              [
                'Swing trading',
                '“I’ll hold for days or weeks to catch a price move.”',
                'News can move the price overnight, while you cannot act.',
              ],
              [
                'Day trading',
                '“I’ll buy and sell inside the same day.”',
                'Extremely high risk — frequent traders lose money quickly and consistently.',
              ],
            ],
          },
        },
    ...
    },
    {
      ...
      sections: [
        ...
        {
          divider: true,
          // Moved here from "What do I buy?": the job you give investing is what
          // decides how much risk you end up carrying.
          heading: 'What’s your goal for investing?',
          bullets: [
            {
              term: 'Grow my money in months',
              text: 'You may take more risk, with shorter-term or more speculative investments.',
            },
            {
              term: 'Grow my money over years',
              text: 'You can go steadier — earn through a career or business, invest part of it, and give it time.',
            },
          ],
        },
        {
          body: 'The more risk you take, the greater the chance of losing money, and there is no single approach for everyone. Choose the level that fits your goals, timeline, and ability to handle losses.',
        },
      ],
      questions: [
        {
      ...
      sections: [
        {
          ...
          bullets: [
            { term: 'Start Investing Consistently', text: 'Invest regularly, stay invested through market ups and downs.' },
        ...
        },
        {
          ...
          body: 'Your biggest advantage isn’t predicting the market. It’s staying invested long enough for your money to compound.',
        },
      ],
      images: [
        {
  ...
  action: {
    title: 'Plan your investing',
    need: [
      'What you’re investing for, and when you’ll need it',
      'Your spending and savings, from the earlier tracks',
    ],
    steps: [
      'Set how much of your income goes to investing.',
      'Pick what you’d invest in.',
    ],
  },
  finalQuiz: [],
}
...
/**
 * How long a track actually takes, start to finish: the reading timers, about
 * half a minute per lesson question, a few minutes for the "your turn" step,
 * and the final test at roughly three minutes per video (watch it, then write
 * an answer) and half a minute per multiple choice.
 *
 * Rounded to the nearest five minutes, because it is an estimate and reading it
 * to the minute would suggest otherwise.
 */
export function trackMinutes(track: Track): number {
  if (track.lessons.length === 0) return 0

  const mix = quizMix(track.id)
  const reading = track.lessons.reduce((s, l) => s + l.readSeconds, 0) / 60
  const questions = track.lessons.reduce((n, l) => n + l.questions.length, 0) * 0.5
  const action = track.action ? 3 : 0
  const final = mix.videos * 3 + mix.choices * 0.5

  return Math.max(5, Math.round((reading + questions + action + final) / 5) * 5)
}
