...
const DEFAULT_KEYWORDS: Record<TrackId, string[]> = {
  ...
  spending: [
    // The three ways to increase income, which is what the lesson is actually
    // about — not budgeting tips.
    'job vs business vs investing',
    'trading time for money',
    'why you should start a business',
    'why you should invest your money',
    'active vs passive income',
    'gross vs net income',
    // Fixed against variable, then the figure the whole track lands on.
    'fixed vs variable expenses',
    'fixed expenses explained',
    'variable expenses budgeting',
    'cash flow explained',
    'personal cash flow',
    'money in vs money out',
  ],
  savings: [
    // Why bother saving at all, then where it goes, then what it earns.
    ...
    'apy explained savings',
    'best savings account interest rates',
  ],
  investing: [
    // Weighted toward the instrument menu — that lesson is the widest one, and
    // one video per instrument is what makes it reviewable.
    'what is investing',
